...
During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!) I plan to implement the following clean coding techniques in my regular work and teach the same to my collegues:Reduce overall line complexity in files, Seperate appropriatly named files containing related functionality, Following Single Responsibility Principle while dealing with functions, Designing/Developing code that is unit testable, Separating unstable code from testable code & Calculating and reducing overall CCM under required industry standard
